 ...
 */
final class Version20220516135055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE account ADD country_id INT DEFAULT NULL, DROP country');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE account ADD country VARCHAR(255) DEFAULT NULL, DROP country_id');
    }
}
